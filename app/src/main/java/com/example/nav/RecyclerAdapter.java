...
/*    public String[] titles = {"Master Control",
            "ColLoRa ID: 65463",
            "ColLoRa ID: 34553",
            "ColLoRa ID: 23452",
            "ColLoRa ID: 76453",
    ...
    public String[] details = {"Switch on all markers",
            "Cow 1", "Cow 2",
            "Cow 3", "Cow 4",
            "Cow 5", "Cow 6",
            "Cow 7","Cow 8" };

    public int[] images = { R.drawable.on_status,
            R.drawable.cowhead,
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        cowslist[0]="Master Control";
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        viewHolder.itemTitle.setText(cowslist[i]);
